  ...
  return (
    <Card className="border-2 hover:border-primary/50 transition-all shadow-lg">
      ...
      <CardContent className="p-6">
        {!hasUserImages && !isWardrobeLoading && (
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <Button 
            type="submit" 
            disabled={loading || isWardrobeLoading || !hasUserImages}
          ...
          >
            {loading || isWardrobeLoading ? <Loader2 className="mr-2 h-5 w-5 animate-spin" /> : null}
            {!hasUserImages && !isWardrobeLoading ? (
              <>
                <Upload className="mr-2 h-5 w-5" />
                Upload Photos First
              </>
            ) : loading ? 'Generating Recommendations...' : isWardrobeLoading ? 'Loading Wardrobe...' : 'Generate Recommendations'}
          </Button>
        </form>
      </CardContent>
